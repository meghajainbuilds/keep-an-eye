...
Product promise: a fast, calm place to find saved products again by category and subcategory, watch a *verified* price, and receive a phone notification when a watch is met. Save first; enrichment can fail gracefully.
